...
public interface Constants
{
    interface GameProperties
    {
        ...
        int GAME_SCENE_WIDTH = 800;
        int GAME_SCENE_HEIGHT = 600;
    ...
    interface GameData
    {
        ...
        Point2D PLAYER_SPAWN_POINT = new Point2D(GameProperties.GAME_SCENE_WIDTH / 2.0, GameProperties.GAME_SCENE_HEIGHT / 2.0);
        Duration ENEMY_SPAWN_DURATION = Duration.seconds(2.0);
